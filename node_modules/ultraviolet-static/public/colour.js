...
//desc: color change (black)
        let elements = document.querySelectorAll(".desc p");
        let bar = document.querySelectorAll("#uv-address");
        
            for (let element of elements) {
            bar.setAttribute("style", "color: black");
    ...
    // change to solid color
      ...
      // desc: color change (white)
     let elements = document.querySelectorAll(".desc p");
     let bar = document.querySelectorAll("#uv-address");
     
        for (let element of elements) {
        element.setAttribute("style", "color: white");
        bar.setAttribute("style", "color: white");
     }

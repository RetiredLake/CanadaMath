...
function getCookie(name) {
    ...
    body.style.backgroundColor = "#000000";
        ...
        let footerElements = document.querySelectorAll("footer a, footer span");
        for (let element of footerElements) {
            element.style.color = "white";
        }
    } else {
        // Update footer text color to black
        let footerElements = document.querySelectorAll("footer a, footer span");
        for (let element of footerElements) {
      ...
      function iniFrame() {
        ...
        if (currentDomain == "japanmath.azurewebsites.net") {
          ...
          if ( window.location !== window.parent.location ) {
                  console.log("Private Mode Unavailable");
                  ...
                  element.onclick = function() {
                      window.open("https://japanmath.azurewebsites.net/");
                  };
                   } else {
